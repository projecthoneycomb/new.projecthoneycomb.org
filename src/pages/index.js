...
const IndexPage = () => {
  ...
  return <Layout>
    ...
    <p><i><strong>TL;DR:</strong> The technology and workload landscapes of education look dire, and new but well-supported ideas like bringing mental health and wellbeing into schools need changes in the way we approach data, security and privacy with software in schools.</i></p>
    <p><i>This is about a 10-minute read but if you are or know teachers, students, parents or school administrators and would like to learn and maybe help make a change, please keep reading.</i></p><hr></hr>
