...
const IndexPage = () => (
  <Layout>
    ...
    <p>As we’ve researched the landscape of software in Education, we were expecting to see big, monolith, for-profit software companies and we found them. Capita and their SIMS products, Go 4 Schools and even Microsoft Office, Google’s G Suite. Most of these solutions are immovable, unimaginative, expensive and aren’t designed with sufficient input from their intended users: teachers, students, administrators and parents. This is creating the burden most teachers are experiencing with frustrating user experiences and duplicate input.</p>
    ...
    <p>Like the USDS and 18F, is there space for a middle ground between these two worlds? One that keeps the innovation, autonomy and creativity of teachers, students and administrators but which comes from a basis of security, privacy, support and best practices. How can these systems and insights shared between schools? Can the money being spent on sub-par software be used more effectively?</p>
