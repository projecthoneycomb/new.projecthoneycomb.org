...
const IndexPage = () => {
  ...
  return <Layout>
    ...
    <p>Project Honeycomb is a not-for-profit initiative to drastically change the way students and teachers can communicate and use technology for the better. <a class="inline" href="/teachers">Learn more</a></p>
    ...
    <p>We want to replicate the best of the 18F model, whilst making sure it easy for grass roots creativity to flourish within it. <a class="inline" href="/platform">Learn more</a></p>
