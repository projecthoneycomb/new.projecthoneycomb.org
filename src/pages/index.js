...
const IndexPage = () => {
  ...
  return <Layout>
    ...
    <p>After this, some of the best of the best programmers, project managers and designers in Silicon Valley left their exciting and well-paid jobs and formed the United States Digital Service and an organisation called 18F. Now, 9 years later, any government agency that needs a digital project can work with them to do so.</p>
    <p>Ultimately, costs have gone down, quality and security have gone up and knowledge and autonomy have been retained inside the public sector and not outsourced to private companies.</p>
