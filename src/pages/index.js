...
const IndexPage = () => {
  ...
  return <Layout>
    ...
    <p>After this, some of the best of the best programmers, project managers and designers in Silicon Valley left their exciting and well-paid jobs and formed the United States Digital Service and an organisation called 18F. Now, 9 years later, any government agency that needs a digital can work with them to do so.</p>
